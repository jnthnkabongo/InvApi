    ...
    <div class="pagetitle">
        <div class="card">
            <div class="row m-3">
                ...
                <div class="col-lg-8 text-center"><h2>Détail de l'utilisateur {{ $utilisateur->name }}</h2></div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form class="row justify-content-center g-3" action="{{ route('modification-utilisateurs', $utilisateur) }}" method="GET">
                    ...
                    <div class="col-md-10">
                        <a href="{{ route('liste-utilisateurs') }}" class="btn btn-primary w-100">Retour à la liste</a>
                    </div>
                </form>
